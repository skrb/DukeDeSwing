...
public class SVGContentBuilder {
    ...
    private void setShapeStyle(Shape shape, StartElement element) {
        ...
        Attribute strokeLinecap = element.getAttributeByName(new QName("stroke-linecap"));
        if (strokeLinecap != null) {
            String linecapValue = strokeLinecap.getValue();
            
            StrokeLineCap linecap = StrokeLineCap.BUTT;
            if (linecapValue.equals("round")) {
                linecap = StrokeLineCap.ROUND;
            } else if (linecapValue.equals("square")) {
                linecap = StrokeLineCap.SQUARE;
            } else if (!linecapValue.equals("butt")) {
                Logger.getLogger(SVGContentBuilder.class.getName()).log(Level.INFO, "No Support Style: {0} {1}", new Object[]{strokeLinecap, linecapValue});
            }
        ...
        Attribute strokeMitterlimit = element.getAttributeByName(new QName("stroke-miterlimit"));
        if (strokeMitterlimit != null) {
            double miterLimit = Double.parseDouble(strokeMitterlimit.getValue());
            shape.setStrokeMiterLimit(miterLimit);
        }

        Attribute strokeLinejoin = element.getAttributeByName(new QName("stroke-linejoin"));
        if (strokeLinejoin != null) {
            String linejoinValue = strokeLinejoin.getValue();
            StrokeLineJoin linejoin = StrokeLineJoin.MITER;
            if (linejoinValue.equals("bevel")) {
                linejoin = StrokeLineJoin.BEVEL;
            } else if (linejoinValue.equals("round")) {
                linejoin = StrokeLineJoin.ROUND;
            } else if (!linejoinValue.equals("miter")) {
                Logger.getLogger(SVGContentBuilder.class.getName()).log(Level.INFO, "No Support Style: {0} {1}", new Object[]{strokeLinejoin, linejoinValue});
            }
